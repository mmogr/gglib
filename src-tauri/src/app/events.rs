...
//!
//! This module provides a single emit helper and constants for all event names,
//! reducing repetitive error-handling boilerplate across commands.
...
/// Extract strings into constants but don't rename to avoid frontend breakage.
pub mod names {
    // Download events
...
/// Emit an event and return whether it succeeded.
///
/// Useful when you need to take action based on emit success.
#[allow(dead_code)]
pub fn emit_checked<T: Serialize + Clone>(app: &AppHandle, event: &str, payload: T) -> bool {
