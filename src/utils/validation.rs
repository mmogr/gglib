...
///
/// ```rust
/// use gglib::utils::validation::validate_file;
/// use std::fs::File;
...
///
/// ```rust,no_run
/// use gglib::utils::validation::validate_and_parse_gguf;
///
/// // Parse a valid GGUF file
/// match validate_and_parse_gguf("./models/llama-2-7b.gguf") {
///     Ok(metadata) => {
...
///         }
///     }
///     Err(e) => eprintln!("Failed to parse GGUF file: {}", e),
/// }
/// ```
pub fn validate_and_parse_gguf(file_path: &str) -> Result<GgufMetadata> {
