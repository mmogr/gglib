/**
 * CouncilThread — self-contained lifecycle component for a single run.
 *
 ...
 *
 * State is stored in the CouncilRegistry (not the legacy singleton
 ...
 *
 * @module components/Council/Thread/CouncilThread
 */
...
import { useCouncilRunStream } from './useCouncilRunStream';
 ...
 */
const CouncilThread: FC<CouncilThreadProps> = ({
  serverPort,
  model,
  className,
  startRunRef,
  ...
  // ── Registry hooks ─────────────────────────────────────────────────────────
  const { register, unregister } = useCouncilRegistry();
  ...
  // ── Streaming hook ─────────────────────────────────────────────────────────
  const { startRun, cancelRun, approve } = useCouncilRunStream({
    dispatch,
    setAbortController,
    abort,
    getPendingApproval,
