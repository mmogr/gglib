 ...
 * completion, etc.).
 *
 * @module components/Council/CompactRunCard
 */
...
function phaseStatusIcon(phase: CouncilPhase, className?: string) {
...
function containerClasses(phase: CouncilPhase): string {
  switch (phase) {
    case 'planning':
    case 'running':
    case 'synthesizing':
