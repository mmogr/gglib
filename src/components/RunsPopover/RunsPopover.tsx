...
const RunsPopover: FC<RunsPopoverProps> = ({
  ...
  return (
    <div className="absolute top-full right-0 mt-xs bg-surface border border-border rounded-md shadow-lg min-w-[280px] max-w-[360px] z-[1000] overflow-hidden" ref={popoverRef}>
