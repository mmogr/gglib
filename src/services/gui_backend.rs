...
use crate::models::gui::{
    AddModelRequest, AppSettings, GuiModel, HfQuantization as GuiHfQuantization,
    HfQuantizationsResponse, HfSearchRequest, HfSearchResponse as GuiHfSearchResponse,
