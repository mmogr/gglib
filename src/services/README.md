...
| `remoteRegistry.ts` | External store for the remote tunnel (ADR 0012): the daemon's status, both sides, plus this window's use-for-chat choice and the model name those turns carry |
