...
- **[Web GUI Server](gui_web/README.md)**: Axum HTTP server and API handlers.
...
**Options:**
- `--quantization <QUANT>`: Specific quantization to download (e.g., "Q4_K_M", "F16")
- `--list-quants`: List available quantizations for the model
- `--add-to-db`: Add to database after download
...
gglib download microsoft/DialoGPT-medium --quantization Q4_K_M --add-to-db
```
