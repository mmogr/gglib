...
impl LlamaServerRunner {
    ...
    pub fn unlimited(base_port: u16, llama_server_path: impl Into<String>) -> Self {
        Self::new(base_port, llama_server_path, 0)
    }

    /// Create a runner for single-server mode (max 1 concurrent).
    pub fn single(base_port: u16, llama_server_path: impl Into<String>) -> Self {
