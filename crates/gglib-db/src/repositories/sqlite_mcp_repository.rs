...
mod tests {
    ...
    async fn test_insert_and_get_by_id() {
        ...
        let new_server =
            NewMcpServer::new_stdio("test-server", "npx", vec!["-y".to_string(), "mcp".to_string()])
    ...
    async fn test_get_by_name() {
        ...
        let new_server = NewMcpServer::new_stdio("my-mcp", "node", vec!["server.js".to_string()]);
    ...
    async fn test_list_servers() {
        ...
        repo.insert(NewMcpServer::new_stdio("server-a", "cmd", vec![]))
            .await
            .unwrap();
        repo.insert(NewMcpServer::new_stdio("server-b", "cmd", vec![]))
            .await
            .unwrap();
    ...
    async fn test_update_server() {
        ...
        let new_server =
            NewMcpServer::new_stdio("updatable", "old-cmd", vec![]).with_env("KEY", "old-value");
    ...
    async fn test_delete_server() {
        ...
        let new_server = NewMcpServer::new_stdio("deletable", "cmd", vec![]);
        let server = repo.insert(new_server).await.unwrap();
        let id = server.id;
    ...
    async fn test_conflict_on_duplicate_name() {
        ...
        repo.insert(NewMcpServer::new_stdio("unique-name", "cmd", vec![]))
            .await
            .unwrap();

        let result = repo
            .insert(NewMcpServer::new_stdio("unique-name", "cmd", vec![]))
            .await;
    ...
    async fn test_update_last_connected() {
        ...
        let new_server = NewMcpServer::new_stdio("connectable", "cmd", vec![]);
        let server = repo.insert(new_server).await.unwrap();
