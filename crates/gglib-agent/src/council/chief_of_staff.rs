...
//!
//! ```rust
//! use gglib_agent::council::chief_of_staff::DepartmentBrief;
...
use crate::council::prompts::{CHIEF_OF_STAFF_SYSTEM_PROMPT, chief_of_staff_schema};
...
///
/// ```rust
/// use gglib_agent::council::chief_of_staff::{DepartmentBrief, MAX_DEPARTMENTS};
/// use gglib_core::domain::council::role_catalog::{RoleCatalog, RoleId};
///
