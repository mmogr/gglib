...
Voice mode pipeline for gglib — fully local speech-to-text, text-to-speech, and voice activity detection.
...
- **`pipeline.rs`** — Voice pipeline state machine (Idle→Listening→Recording→Transcribing→Speaking)
