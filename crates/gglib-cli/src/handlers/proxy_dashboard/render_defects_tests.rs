...
fn the_proxys_own_counts_are_read_through_the_mirror() {
    let sent = gglib_core::domain::defects::ModelDefectCounts {
        ...
        agent_guard_scanned: 5,
        agent_guard_trips: 6,
        agent_guard_loops: 7,
        agent_guard_stagnations: 8,
        repairs_attempted: 9,
        repairs_succeeded: 10,
        stream_errors: 11,
        truncated_generations: 12,
        empty_responses: 13,
        reasoning_only: 14,
        dialect_residue: 15,
        unvalidatable_schemas: 16,
        normalization_errors: 17,
        identical_result_repeats: 18,
        repeats_not_evaluated: 19,
        repeats_rescued: 20,
    };
    ...
    let read = [
        ...
        got.agent_guard_scanned,
        got.agent_guard_trips,
        got.agent_guard_loops,
        got.agent_guard_stagnations,
