...
pub enum Commands {
    ...
    Question {
        ...
        /// With --remote it is mandatory instead — the name is forwarded as given
        /// and this machine's default is a model the far one may not have — so
        /// omit it and the request arrives there empty: 404 Model '' not found.
        #[arg(short, long)]
        model: Option<String>,
