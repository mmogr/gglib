//! `POST /api/orchestrator/approve/{approval_id}` — resolve a HITL gate.
//!
...
/// Request body for `POST /api/orchestrator/approve/{approval_id}`.
...
/// Response body for `POST /api/orchestrator/approve/{approval_id}`.
...
// ─── POST /api/orchestrator/approve/{approval_id} ────────────────────────────
