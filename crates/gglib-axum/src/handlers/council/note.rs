//! `POST /api/council/runs/{run_id}/note` — enqueue a natural-language
...
//! [`CouncilEvent::SteeringApplied`] event on the SSE stream.
//!
...
/// Request body for `POST /api/council/runs/{run_id}/note`.
...
// ─── POST /api/council/runs/{run_id}/note ───────────────────────────────
