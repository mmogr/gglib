...
impl From<&McpServiceError> for McpErrorCategory {
    fn from(error: &McpServiceError) -> Self {
        match error {
            McpServiceError::Repository(_) => McpErrorCategory::Unknown,
            McpServiceError::StartFailed(_) => McpErrorCategory::Process,
            McpServiceError::StopFailed(_) => McpErrorCategory::Process,
            McpServiceError::NotRunning(_) => McpErrorCategory::Process,
            McpServiceError::Protocol(_) => McpErrorCategory::Protocol,
            McpServiceError::ToolError(_) => McpErrorCategory::Tool,
            McpServiceError::InvalidConfig(_) => McpErrorCategory::Configuration,
            McpServiceError::Internal(_) => McpErrorCategory::Unknown,
        }
    }
}
