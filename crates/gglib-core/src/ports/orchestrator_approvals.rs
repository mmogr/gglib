...
//!
//! 1. Creates a oneshot channel and calls [`OrchestratorApprovalRegistryPort::register`]
//!    with the sender.
//! 2. Emits [`crate::domain::orchestrator::events::OrchestratorEvent::AwaitingApproval`]
...
//! [`OrchestratorApprovalRegistryPort::resolve`].

use async_trait::async_trait;
use tokio::sync::oneshot;

use crate::domain::orchestrator::task_graph::TaskGraph;
...
// =============================================================================
// OrchestratorApprovalRegistryPort
// =============================================================================
...
#[async_trait]
pub trait OrchestratorApprovalRegistryPort: Send + Sync + 'static {
