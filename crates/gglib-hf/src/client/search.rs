...
impl<B: HttpBackend> HfClient<B> {
    ...
    pub(crate) async fn search_models_page(&self, query: &HfSearchQuery) -> HfResult<HfSearchResponse> {
    ...
    pub(crate) async fn search_all_models(&self, query: HfSearchQuery) -> HfResult<Vec<HfModelSummary>> {
