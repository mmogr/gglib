...
fn test_model_info_serialize() {
    let info = gglib::proxy::models::ModelInfo {
...
fn test_error_response_new() {
    let error = gglib::proxy::models::ErrorResponse::new("Model not found", "not_found");
...
fn test_chat_completion_response_serialize() {
    let response = gglib::proxy::models::ChatCompletionResponse {
        id: "chatcmpl-123".to_string(),
        object: "chat.completion".to_string(),
        created: 1700000000,
        model: "llama-7b".to_string(),
        choices: vec![gglib::proxy::models::ChatChoice {
            index: 0,
        ...
        usage: Some(gglib::proxy::models::Usage {
            prompt_tokens: 10,
            completion_tokens: 5,
            total_tokens: 15,
        }),
...
fn test_chat_completion_chunk_serialize() {
    let chunk = gglib::proxy::models::ChatCompletionChunk {
        id: "chatcmpl-123".to_string(),
        object: "chat.completion.chunk".to_string(),
        created: 1700000000,
        model: "llama-7b".to_string(),
        choices: vec![gglib::proxy::models::ChatChunkChoice {
            index: 0,
...
fn test_usage_serialize_deserialize() {
    let usage = gglib::proxy::models::Usage {
        prompt_tokens: 100,
    ...
    let deserialized: gglib::proxy::models::Usage = serde_json::from_str(&json).unwrap();
