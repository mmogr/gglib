...
and `no_sampler_flag_may_reappear_unnoticed`, a unit test in
`crates/gglib-runtime/src/llama/args/sampling.rs`, fails when the constant
disagrees with whether `sampler_flags()` returns a flag — in either direction,
so the instrument can neither claim sight it lacks nor stay blind after it is
freed.
...
Readings: [log-0004, 2026-08-10](log-0004.md#addendum--the-ab-instrument-and-the-first-thing-it-measured)
...
Readings: [log-0004, 2026-08-29](log-0004.md#addendum--the-instrument-was-reporting-a-comparison-it-had-not-taken)
...
Readings: [log-0004, 2026-09-20](log-0004.md#addendum--the-first-reading-through-the-proxy-2026-09-20)
